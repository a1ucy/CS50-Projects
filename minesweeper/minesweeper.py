...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence = Sentence(undetermined, count - num_mines)
        ...
        for sentence in self.knowledge:
            if sentence == new_Sentence:
                ...
                num = sentence.count - new_Sentence.count
                new_kb.append(Sentence(new_set, num))
